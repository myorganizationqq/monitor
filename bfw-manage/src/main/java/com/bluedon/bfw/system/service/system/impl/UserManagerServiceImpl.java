...
public class UserManagerServiceImpl extends BaseServiceImpl implements IUserManagerService {
	...
	public PageUtil getPageList(UserManagerModel param,PageUtil pageUtil){
		...
		if(pageUtil.fetchPaging()){
			String hql = "select new com.bluedon.bfw.system.entity.UserAndOrgAnddepart(u.id,u.loginName,u.password,u.realName,u.departId,u.orgId,u.userType,u.isValid"
	...
	public List<UserAndOrgAnddepart> getListRoleName(String idArr) {
		String hql = "select new com.bluedon.bfw.system.entity.UserAndOrgAnddepart(u.id,r.rolename) from TbCommonUser u,TbCommonRole r"
