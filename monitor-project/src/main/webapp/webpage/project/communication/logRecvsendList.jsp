...
<script type="text/javascript" src="${requestScope.basePath}webpage/js/communication/logRecvsendManage.js"></script>
	...
	<div class="tahoma_font tableStyle_5_0">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="160">
					<input type="t" class="easyui-textbox" id="linkIp"
						style="width: 150px" data-options="" fit="true" />
				</td>
				<td width="80" style="padding-left:20px;"><label>服务器编号：</label></td>
				<td width="160">
					<input type="t" class="easyui-textbox" id="serverCode"
						style="width: 150px" data-options="" fit="true" />
				</td>
