...
<head>
    ...
    <script type="text/javascript" src="${requestScope.basePath }webpage/js/project/network/snmpInfo.js"></script>
</head>
<body>
<div style="width: 99%; padding-top: 10px; padding-left: 10px"
    ...
    <div class="tahoma_font tableStyle_5_0">
        ...
        <form id="snmpInfo_search_form">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>

                    <td width="60" style="padding-right:10px;"><label>状态：</label></td>
                    <td width="160">
